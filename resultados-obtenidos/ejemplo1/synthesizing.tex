\subsection{Sistema generado por el ACG}
	...
	En base a la red de grafos, ilustrada en la Figura \ref{fig:EJ1_8}, el ACG determinó la siguiente cantidad de elementos, tal puede visualizarse en el Código \ref{lst:EJ1_8}.
	...
	En este ejemplo, la cantidad de recursos utilizados es baja y el tiempo de sintetización e implementación es de 47 y 44 segundos respectivamente.