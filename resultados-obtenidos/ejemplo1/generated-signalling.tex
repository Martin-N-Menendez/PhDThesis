\subsection{Tabla de enclavamiento generada por el RNA}
    ...
    \begin{table}[H]
        {
        \caption{Tabla de enclavamientos del ejemplo 1 generada por el RNA.}
        ...
        \resizebox{1\textwidth}{!}{
            \begin{tabular}{ c c c c c c c }
                ...
                \hline
                    ...
                    R$_{06}$  & J$_{13}$ & C$_{25}$ & Sw$_{13}^{N}$ & - & - & ne$_{23}$-ne$_{12}$\\
                    R$_{07}$  & X$_{15}$ & T$_{03}$ & - & Plat$_{11}$ & Lc$_{06}$ & ne$_{14}$\\
                    R$_{08}$  & X$_{16}$ & L$_{07}$ & Sw$_{04}^{R}$+Sw$_{07}^{R}$ & - & Lc$_{06}$ & ne$_{14}$-ne$_{01}$\\
