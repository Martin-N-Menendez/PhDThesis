\subsection{Señalamiento generado por el RNA}
    ...
    El RNa también exporta la misma información mostrada en el Código \ref{lst:EJ1_8} en una hoja de cálculo, similar a la que se visualiza en la Tabla \ref{Tab:tabla_generated_1}.
