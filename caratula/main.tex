...
\begin{titlepage}
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \node[align=right, text width=1.4\textwidth] at (6,-21.15) {\fontsize{10}{30}\selectfont \textit{Este trabajo fue realizado en la Ciudad Autónoma de Buenos Aires, entre Julio de 2024 y Marzo de 2024}};
    \end{tikzpicture}
\end{titlepage}
